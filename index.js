...
class Car {
   ...
   */
  drive(distance) {
    const distanceCapability = this.tank * this.mpg
    if (distance <= distanceCapability) {
      this.odometer = this.odometer + distance
      this.tank = this.tank - (distance / this.mpg)
      return this.odometer
    }
    this.odometer = this.odometer + distanceCapability
    this.tank = 0
    return this.odometer
  }
   ...
   */
  refuel(gallons) {
    const maxFill = this.tankSize - this.tank
    if (gallons <= maxFill) {
